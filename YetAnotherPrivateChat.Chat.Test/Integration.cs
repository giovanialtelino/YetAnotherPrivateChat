...
using YetAnotherPrivateChat.Chat;
using System.Text;
...
namespace YetAnotherPrivateChat.Chat.Test
{
    ...
    public class Integration : IClassFixture<CustomWebApplicationFactory<YetAnotherPrivateChat.Chat.Startup>>
    {
        private readonly CustomWebApplicationFactory<YetAnotherPrivateChat.Chat.Startup> _factory;

        public Integration(CustomWebApplicationFactory<YetAnotherPrivateChat.Chat.Startup> factory)
        {
            _factory = factory;
        }
